...
@endpush
    ...
    <div class="container">
        <div class="form-container">
            <h1 class="page-title">Dodaj narudžbinu</h1>

            <form action="{{ route('narudzbinas.store') }}" method="POST" id="narudzbina-form">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-row">
                            <label class="form-label">Unesite status:</label>
                            <select 
                                name="status" 
                            ...
                            >
                                ...
                                <option value="Naruceno" {{ old('status') == 'Naruceno' ? 'selected' : '' }}>Naručeno</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-row">
                            <label class="form-label">Unesite datum:</label>
                            <input 
                                type="date" 
                                name="datum" 
                ...
                <div class="items-table">
                    <h5 class="mb-3">Dodajte artikle:</h5>
                ...
                <div class="buttons-container">
                    <button type="submit" class="btn btn-submit">Dodajte narudžbinu</button>
