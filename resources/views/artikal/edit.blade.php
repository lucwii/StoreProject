...
@section('content')
    ...
    <div class="container">
        <div class="form-container">
            <h1 class="page-title">Izmeni artikal</h1>

            <form action="{{ route('artikals.update', $artikal) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-row">
                            <label class="form-label">Izmenite naziv:</label>
                            <input 
                                type="text" 
                                name="naziv" 
                                class="form-input @error('naziv') is-invalid @enderror" 
                                placeholder="Naziv" 
                                value="{{ old('naziv', $artikal->naziv) }}"
                                required
                            >
                            @error('naziv')
                    ...
                    <div class="col-md-4">
                        <div class="form-row">
                            <label class="form-label">Izmenite opis:</label>
                            <textarea 
                                name="opis" 
                                class="form-textarea @error('opis') is-invalid @enderror" 
                                placeholder="Opis"
                            >{{ old('opis', $artikal->opis) }}</textarea>
                            @error('opis')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-row">
                            <label class="form-label">Izmenite nabavnu cenu:</label>
                            <input 
                                type="number" 
                                step="0.01" 
                                name="nabavna_cena" 
                                ...
                                value="{{ old('nabavna_cena', $artikal->nabavna_cena) }}"
                                required
                            >
                            @error('nabavna_cena')
                                <div class="error-message">{{ $message }}</div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-row">
                            <label class="form-label">Izmenite prodajnu cenu:</label>
                            <input 
                                type="number" 
                                step="0.01" 
                                name="prodajna_cena" 
                                ...
                                value="{{ old('prodajna_cena', $artikal->prodajna_cena) }}"
                                required
                            >
                            @error('prodajna_cena')
                                <div class="error-message">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        <div class="form-row">
                            <label class="form-label">Izmenite količinu:</label>
                            <input 
                                type="number" 
                                name="kolicina_na_stanju" 
                                class="form-input @error('kolicina_na_stanju') is-invalid @enderror" 
                                placeholder="Količina" 
                                value="{{ old('kolicina_na_stanju', $artikal->kolicina_na_stanju) }}"
                                required
                            >
                        ...
                        <div class="form-row">
                            ...
                            >
                                ...
                                @foreach($dobavljaci as $dobavljac)
                                    <option value="{{ $dobavljac->id }}" {{ old('dobavljac_id', $artikal->dobavljac_id) == $dobavljac->id ? 'selected' : '' }}>
                                        {{ $dobavljac->naziv }}
                                    </option>
                                @endforeach
                            </select>
